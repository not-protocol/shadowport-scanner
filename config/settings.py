"""
config/settings.py — ShadowPort Scanner v1.3.0
Central configuration: version, paths, scan modes, profiles.
"""
...
RELEASE   = "From scanner to reconnaissance platform."
...
# ─── Scan modes ───────────────────────────────────────────────────────────────
SCAN_MODES = {
    "1": {"name": "Quick Scan",        "args": "",               "description": "Top 1000 common ports",            "eta": 15,  "root": False},
    "2": {"name": "Full TCP Scan",     "args": "-p-",            "description": "All 65535 TCP ports",              "eta": 120, "root": False},
    "3": {"name": "Service Detection", "args": "-sV",            "description": "Services + version banners",       "eta": 30,  "root": False},
    "4": {"name": "OS Detection",      "args": "-O",             "description": "OS fingerprinting",                "eta": 25,  "root": True },
    "5": {"name": "Aggressive Scan",   "args": "-A",             "description": "OS + versions + scripts",          "eta": 60,  "root": True },
    "6": {"name": "Host Discovery",    "args": "-sn",            "description": "Ping sweep — is host alive?",      "eta": 5,   "root": False},
    "7": {"name": "Stealth SYN Scan",  "args": "-sS",            "description": "Silent SYN scan",                  "eta": 20,  "root": True },
    "8": {"name": "Vuln Scripts",      "args": "--script vuln",  "description": "NSE vulnerability scripts",        "eta": 90,  "root": False},
}
...
# Informational only — not vulnerability detection
SERVICE_INTEL = {
...
# Higher score = higher risk weight per open port
RISK_WEIGHTS = {
